...
const InterviewCard = ({interviewId, userId, role, type,techstack,
  createdAt }: InterviewCardProps) => {
    ...
    const formatterDate = dayjs(feedback?.createdAt || createdAt ||
  ...
  return (
    ...
    max-sm:w-full min-h-96">
      ...
      <div className= "card-interview">
        <div>
          <div className="absolute top-0 right-0 w-fir px-4
          py-2 rounded-bl-lg bg-light-600">
            <p
              className="badge-text">{normalizedType}
            </p>
          </div>
          <Image 
